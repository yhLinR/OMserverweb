...
INTERNAL_IPS = ('127.0.0.1','172.16.1.162',)
...
DATABASES = {
    'default': {
        ...
        'USER': 'omserver',                      # Not used with sqlite3.
        'PASSWORD': '666666',                  # Not used with sqlite3.
        'HOST': '172.16.1.162',                      # Set to empty string for localhost. Not used with sqlite3.
...
TEMPLATE_DIRS = (
    ...
    '/usr/local/python2.7.15/lib/python2.7/site-packages/django_debug_toolbar-0.8.5-py2.7.egg/debug_toolbar/templates',
    BASE_DIR+'/templates'
)
